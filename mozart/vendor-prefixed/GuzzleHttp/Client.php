...
use MozartTest\GuzzleHttp\Cookie\CookieJar;
use MozartTest\GuzzleHttp\Exception\GuzzleException;
use MozartTest\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \MozartTest\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
    ...
    private function transfer(RequestInterface $request, array $options): PromiseInterface
    {
        ...
        try {
            return MozartTest\GuzzleHttp\Promise\Create::promiseFor($handler($request, $options));
        } catch (\Exception $e) {

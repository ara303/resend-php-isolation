...
class ContactProperty extends Service
{
     ...
     */
    public function get(string $id): \MozartTest\Resend\ContactProperty
    {
     ...
     */
    public function create(array $parameters): \MozartTest\Resend\ContactProperty
    {
     ...
     */
    public function update(string $id, array $parameters): \MozartTest\Resend\ContactProperty
    {
     ...
     */
    public function remove(string $id): \MozartTest\Resend\ContactProperty
    {

...
class Broadcast extends Service
{
     ...
     */
    public function get(string $id): \MozartTest\Resend\Broadcast
    {
     ...
     */
    public function create(array $parameters): \MozartTest\Resend\Broadcast
    {
     ...
     */
    public function update(string $id, array $parameters): \MozartTest\Resend\Broadcast
    {
     ...
     */
    public function send(string $broadcastId, array $parameters): \MozartTest\Resend\Broadcast
    {
     ...
     */
    public function remove(string $id): \MozartTest\Resend\Broadcast
    {

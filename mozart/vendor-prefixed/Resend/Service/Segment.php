...
class Segment extends Service
{
     ...
     */
    public function get(string $id): \MozartTest\Resend\Segment
    {
     ...
     */
    public function create(array $parameters): \MozartTest\Resend\Segment
    {
     ...
     */
    public function remove(string $id): \MozartTest\Resend\Segment
    {

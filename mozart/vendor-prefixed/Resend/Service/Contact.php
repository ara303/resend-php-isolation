...
use MozartTest\Resend\Service\Contacts\Segment;
use MozartTest\Resend\Service\Contacts\Topic;
...
class Contact extends Service
{
     ...
     */
    public function get(string $idOrEmail): \MozartTest\Resend\Contact
    {
     ...
     */
    public function create(array $parameters): \MozartTest\Resend\Contact
    {
     ...
     */
    public function update(string $idOrEmail, array $parameters): \MozartTest\Resend\Contact
    {
     ...
     */
    public function remove(string $idOrEmail): \MozartTest\Resend\Contact
    {

...
class Domain extends Service
{
     ...
     */
    public function get(string $id): \MozartTest\Resend\Domain
    {
     ...
     */
    public function create(array $parameters): \MozartTest\Resend\Domain
    {
     ...
     */
    public function update(string $id, array $parameters): \MozartTest\Resend\Domain
    {
     ...
     */
    public function remove(string $id): \MozartTest\Resend\Domain
    {
     ...
     */
    public function verify(string $id): \MozartTest\Resend\Domain
    {

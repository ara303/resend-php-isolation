...
class Template extends Service
{
     ...
     */
    public function get(string $id): \MozartTest\Resend\Template
    {
     ...
     */
    public function create(array $parameters, array $options = []): \MozartTest\Resend\Template
    {
     ...
     */
    public function update(string $id, array $parameters): \MozartTest\Resend\Template
    {
     ...
     */
    public function remove(string $id): \MozartTest\Resend\Template
    {
     ...
     */
    public function publish(string $id): \MozartTest\Resend\Template
    {
     ...
     */
    public function duplicate(string $id): \MozartTest\Resend\Template
    {

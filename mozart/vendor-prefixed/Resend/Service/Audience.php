...
class Audience extends Service
{
     ...
     */
    public function get(string $id): \MozartTest\Resend\Audience
    {
     ...
     */
    public function create(array $parameters): \MozartTest\Resend\Audience
    {
     ...
     */
    public function remove(string $id): \MozartTest\Resend\Audience
    {

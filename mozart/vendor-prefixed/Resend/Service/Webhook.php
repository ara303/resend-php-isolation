...
use MozartTest\Resend\WebhookSignature;
class Webhook extends Service
{
     ...
     */
    public function get(string $id): \MozartTest\Resend\Webhook
    {
     ...
     */
    public function create(array $parameters): \MozartTest\Resend\Webhook
    {
     ...
     */
    public function update(string $id, array $parameters): \MozartTest\Resend\Webhook
    {
     ...
     */
    public function remove(string $id): \MozartTest\Resend\Webhook
    {

...
namespace MozartTest\Resend\Service\Emails\Receiving;
...
class Attachment extends Service
{
     ...
     */
    public function get(string $emailId, string $id): \MozartTest\Resend\Emails\Attachment
    {
     ...
     */
    public function list(string $emailId, array $options = []): \MozartTest\Resend\Collection
    {

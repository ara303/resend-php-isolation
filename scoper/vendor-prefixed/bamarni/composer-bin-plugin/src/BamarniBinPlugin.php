...
use ScoperTest\Bamarni\Composer\Bin\CommandProvider as BamarniCommandProvider;
use ScoperTest\Bamarni\Composer\Bin\Config\Config;
use ScoperTest\Bamarni\Composer\Bin\Input\BinInputFactory;
use ScoperTest\Composer\Composer;
use ScoperTest\Composer\Console\Application;
use ScoperTest\Composer\EventDispatcher\EventSubscriberInterface;
use ScoperTest\Composer\IO\ConsoleIO;
use ScoperTest\Composer\IO\IOInterface;
use ScoperTest\Composer\Plugin\CommandEvent;
use ScoperTest\Composer\Plugin\PluginEvents;
use ScoperTest\Composer\Plugin\PluginInterface;
use ScoperTest\Composer\Plugin\Capable;
use ScoperTest\Composer\Script\Event;
use ScoperTest\Composer\Script\ScriptEvents;
use ScoperTest\Symfony\Component\Console\Command\Command;
use ScoperTest\Composer\Plugin\Capability\CommandProvider as ComposerPluginCommandProvider;

...
namespace ScoperTest\GuzzleHttp;

use ScoperTest\GuzzleHttp\Cookie\CookieJar;
use ScoperTest\GuzzleHttp\Exception\GuzzleException;
use ScoperTest\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \ScoperTest\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**

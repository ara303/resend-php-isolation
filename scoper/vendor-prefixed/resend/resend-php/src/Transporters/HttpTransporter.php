...
namespace ScoperTest\Resend\Transporters;

use Closure;
use ScoperTest\GuzzleHttp\Exception\ClientException;
use JsonException;
use ScoperTest\Psr\Http\Client\ClientExceptionInterface;
use ScoperTest\Psr\Http\Client\ClientInterface;
...
class HttpTransporter implements Transporter
{
    ...
    public function request(Payload $payload): array
    {
        ...
        try {
            $data = json_decode($contents, \true, 512, \JSON_THROW_ON_ERROR);

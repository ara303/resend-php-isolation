...
class ServiceFactory
{
     ...
     */
    private static array $classMap = ['apiKeys' => ApiKey::class, 'audiences' => Audience::class, 'batch' => Batch::class, 'broadcasts' => Broadcast::class, 'contacts' => Contact::class, 'contactProperties' => ContactProperty::class, 'domains' => Domain::class, 'emails' => Email::class, 'segments' => Segment::class, 'templates' => Template::class, 'topics' => Topic::class, 'webhooks' => Webhook::class];
    /**

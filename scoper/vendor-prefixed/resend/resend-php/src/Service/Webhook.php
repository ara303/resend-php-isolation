...
use ScoperTest\Resend\WebhookSignature;
class Webhook extends Service
{
     ...
     */
    public function get(string $id): \ScoperTest\Resend\Webhook
    {
     ...
     */
    public function create(array $parameters): \ScoperTest\Resend\Webhook
    {
     ...
     */
    public function update(string $id, array $parameters): \ScoperTest\Resend\Webhook
    {
     ...
     */
    public function remove(string $id): \ScoperTest\Resend\Webhook
    {

...
class ContactProperty extends Service
{
     ...
     */
    public function get(string $id): \ScoperTest\Resend\ContactProperty
    {
     ...
     */
    public function create(array $parameters): \ScoperTest\Resend\ContactProperty
    {
     ...
     */
    public function update(string $id, array $parameters): \ScoperTest\Resend\ContactProperty
    {
     ...
     */
    public function remove(string $id): \ScoperTest\Resend\ContactProperty
    {

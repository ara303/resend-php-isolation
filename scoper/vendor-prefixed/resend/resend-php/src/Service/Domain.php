...
class Domain extends Service
{
     ...
     */
    public function get(string $id): \ScoperTest\Resend\Domain
    {
     ...
     */
    public function create(array $parameters): \ScoperTest\Resend\Domain
    {
     ...
     */
    public function update(string $id, array $parameters): \ScoperTest\Resend\Domain
    {
     ...
     */
    public function remove(string $id): \ScoperTest\Resend\Domain
    {
     ...
     */
    public function verify(string $id): \ScoperTest\Resend\Domain
    {

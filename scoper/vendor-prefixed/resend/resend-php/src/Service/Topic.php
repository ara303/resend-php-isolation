...
class Topic extends Service
{
     ...
     */
    public function get(string $id): \ScoperTest\Resend\Topic
    {
     ...
     */
    public function create(array $parameters, array $options = []): \ScoperTest\Resend\Topic
    {
     ...
     */
    public function update(string $id, array $parameters): \ScoperTest\Resend\Topic
    {
     ...
     */
    public function remove(string $id): \ScoperTest\Resend\Topic
    {

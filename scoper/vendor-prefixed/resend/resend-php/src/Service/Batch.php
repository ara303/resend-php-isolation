...
class Batch extends Service
{
     ...
     */
    public function create(array $parameters, array $options = []): \ScoperTest\Resend\Collection
    {
     ...
     * @see https://resend.com/docs/api-reference/emails/send-batch-emails
     */
    public function send(array $parameters, array $options = []): \ScoperTest\Resend\Collection
    {

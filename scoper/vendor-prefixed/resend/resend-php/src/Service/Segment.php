...
class Segment extends Service
{
     ...
     */
    public function get(string $id): \ScoperTest\Resend\Segment
    {
     ...
     */
    public function create(array $parameters): \ScoperTest\Resend\Segment
    {
     ...
     */
    public function remove(string $id): \ScoperTest\Resend\Segment
    {

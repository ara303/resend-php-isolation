...
class Template extends Service
{
     ...
     */
    public function get(string $id): \ScoperTest\Resend\Template
    {
     ...
     */
    public function create(array $parameters, array $options = []): \ScoperTest\Resend\Template
    {
     ...
     */
    public function update(string $id, array $parameters): \ScoperTest\Resend\Template
    {
     ...
     */
    public function remove(string $id): \ScoperTest\Resend\Template
    {
     ...
     */
    public function publish(string $id): \ScoperTest\Resend\Template
    {
     ...
     */
    public function duplicate(string $id): \ScoperTest\Resend\Template
    {

...
namespace ScoperTest\Resend\ValueObjects\Transporter;

use ScoperTest\GuzzleHttp\Psr7\Request;
use InvalidArgumentException;
use ScoperTest\Psr\Http\Message\RequestInterface;
use ScoperTest\Resend\Resend;
use ScoperTest\Resend\Enums\Transporter\ContentType;
use ScoperTest\Resend\Enums\Transporter\Method;
use ScoperTest\Resend\ValueObjects\ResourceUri;
final class Payload
{
    /**

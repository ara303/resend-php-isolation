...
final class Headers
{
    ...
    {
        return new self([...$this->headers, $header => $value]);
    }
    /**
    ...
    {
        return new self([...$this->headers, 'User-Agent' => $name . '/' . $version]);
    }
    /**
    ...
    {
        return new self([...$this->headers, 'Idempotency-Key' => $key]);
    }
    /**
    ...
    {
        return new self([...$this->headers, ...$headersToMerge->toArray()]);
    }
    /**
